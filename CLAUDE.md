...
Intelligent memory system for Claude Code. 147 features, 3,000 tests, Python 3.11+. Extracts knowledge from sessions, grades it, searches it semantically, and synthesizes insights across projects.
