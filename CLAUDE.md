...
Intelligent memory system for Claude Code. 124 features, 2,435 tests, Python 3.11+. Extracts knowledge from sessions, grades it, searches it semantically, and synthesizes insights across projects.
