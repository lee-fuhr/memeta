...
def _parse_args():
    import argparse
    p = argparse.ArgumentParser(description="Memeta dashboard server")
...
def api_export():
    ...
    if fmt == "csv":
        ...
        return Response(
            output.getvalue(),
            mimetype="text/csv",
            headers={"Content-Disposition": "attachment; filename=memeta-memories.csv"},
        )
...
if __name__ == "__main__":
    ...
    print(f"Memeta dashboard — http://localhost:{args.port}")
