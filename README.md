...
![Python](https://img.shields.io/badge/python-3.11%2B-blue) ![Tests](https://img.shields.io/badge/tests-2%2C267%20passing-brightgreen) ![Version](https://img.shields.io/badge/version-0.24.0-blue) ![License](https://img.shields.io/badge/license-MIT-green)
...
| Pattern detection | None | 118 features including dream synthesis |
...
118 features across 6 layers, all additive:
...
*118 features · 2,267 tests · every methodology · all additive*
