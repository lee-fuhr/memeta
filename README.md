...
![Python](https://img.shields.io/badge/python-3.11%2B-blue) ![Tests](https://img.shields.io/badge/tests-2%2C665%20passing-brightgreen) ![Version](https://img.shields.io/badge/version-0.27.0-blue) ![License](https://img.shields.io/badge/license-MIT-green)
...
| Pattern detection | None | 133 features including dream synthesis, session-start briefing |
...
133 features across 6 layers, all additive:
...
*133 features · 2,665 tests · every methodology · all additive*
